...
let variableParaGuardarElElementoSeleccionado =
  document.getElementById("miAudio");

miAudio.addEventListener("click", function () {
  let contenidoDelA =
    variableParaGuardarElElementoSeleccionado.getAttribute("type");
...
//Función para desabilitar los botones si el input
//está vacío. (Ahora no hace nada importante)
